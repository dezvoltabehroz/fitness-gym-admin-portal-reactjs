...
const TraineeDetails = () => {
   ...
   const [viewPauseMembershipModal, setPauseMembershipModal] = useState(false);
   ...
   return (
      <Fragment>
                        ...
                        actions={[
                           {
                              icon: 'remove_red_eye',
                              tooltip: 'View Detail',
                              onClick: (event, rowData) => setViewProfileModal(true)
                           },
                           {
                              icon: "add_box",
                              tooltip: "Add Trainee",
         ...
         <Modal show={viewProfileModal} size="lg" >
            <Modal.Header>
               <Button variant="" className="close" onClick={() => setViewProfileModal(false)} > <span>&times;</span> </Button>
               <br />
            </Modal.Header>
            <Modal.Body>
               <Container>
                           ...
                           <Col>
                              <Card>
                                 <Card.Body>
                                    ...
                                    <Button variant="primary" onClick={() => setViewProfileModal(false)} className="float-right btn-xs">Update</Button>
                                    <Button variant="light" onClick={() => setPauseMembershipModal(true)} className="float-right mr-3 btn-xs"> Pause Membership </Button>
                                 </Card.Body>
                              </Card>
                           </Col>
                        </Row>
         ...
         <Modal show={viewPauseMembershipModal} size="md" >
            <Modal.Header>
               <Button variant="" className="close" onClick={() => setPauseMembershipModal(false)} > <span>&times;</span> </Button>
               <br />
            </Modal.Header>
            <Modal.Body>
               <Container>
                  ...
                  <div className="row justify-content-md-center">
                     <Button variant="light" onClick={() => setPauseMembershipModal(false)} className="align-self-center mr-3 btn-md"> Pause Membership </Button>
                  </div>
