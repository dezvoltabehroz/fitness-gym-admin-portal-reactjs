                                            ...
                                            <div className="basic-form">
                                                <div className="form-row d-flex justify-content-center">
                                                    <div className="form-group col-md-6">
                                                        <img src={uploadimage} data-holder-rendered="true" onClick={handleUploadImgae} />
                                                        <br />
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <hr />
                                    <Button variant="primary" className="float-right" onClick={completedStep1} >Next</Button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <hr />
                                    <Button variant="primary" className="float-right" onClick={completedStep2} >Next</Button>
                                    {isBack == true ? <Button variant="light" className="float-right mr-3" onClick={handleBack2} >Back</Button> : null}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <hr />
                                    <Button variant="primary" className="float-right" onClick={completedStep3} >Next</Button>
                                    {isBack == true ? <Button variant="light" className="float-right mr-3" onClick={handleBack3} >Back</Button> : null}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <hr />
                                    <Button variant="primary" className="float-right" onClick={completedStep4} >Add Trainee</Button>
                                    <Button variant="light" className="float-right mr-3" onClick={handleBack4} >Back</Button>
                                </div>
                            </div>
                        </div>
                    </div>
